        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/' . config('bytenet.admin.base.route_prefix') . '/password/reset') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btn btn-primary">
                                    {{ trans('bytenet-admin-base::base.reset_password') }}
                                </button>
                            </div>
                        </div>
                    </form>
